...
if (window.innerWidth >= 600) {
    // Führen Sie hier Ihren JavaScript-Code für größere Bildschirme aus
    ...
    document.getElementById('someElement').addEventListener('click', function() {
        // Beispiel: Fügen Sie hier eine Event-Listener-Funktion hinzu
        alert('JavaScript-Code für größere Bildschirme');
    });

    // Weitere JavaScript-Code für größere Bildschirme
} else {
    // JavaScript-Code, der für kleinere Bildschirme ignoriert wird
    // Sie können hier optional spezifischen Code für kleinere Bildschirme einfügen
}
